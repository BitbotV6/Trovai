...
export default async (req) => {
  ...
  try {
    // Pad-based ophalen: ?include= wordt door de LOCA Store-API genegeerd en geeft
    // de verkeerde (nieuwste) woning terug. /products/<id> levert wel de juiste.
    ...
    if (!data || !data.id) return new Response(JSON.stringify({ error: 'Niet gevonden' }), { status: 404, headers });
